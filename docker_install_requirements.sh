...
apt update && apt upgrade -- assume-yes && apt install --assume-yes python3 postgresql-client libcrypt-rijndael-perl libcrypt-cbc-perl gawk
git clone https://github.com/clarus-proxy/benchmarking.git
